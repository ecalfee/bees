...
# this script calculates allele frequencies for a population and list of bams at ancestry informative markers (AIMs)

# to run: ./AIMs_allele_freq.sh AR01 Group1 A
...
SNP_FILE="results/AIMs/${AIM_ANCESTRY}/${SCAFFOLD}.var.sites"
REGIONS_FILE="../geno_lik_and_SNPs/results/${PREFIX}/variant_sites/${SCAFFOLD}.regions"
DIR_OUT="results/AIMs/${AIM_ANCESTRY}/${SCAFFOLD}"
...
echo "Calculating allele frequencies for POP: "$POP" at AIMs for ancestry "${AIM_ANCESTRY}
